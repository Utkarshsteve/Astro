...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [BirthChartComponent, DailyHoroscopeComponent, HeaderComponent, LandingPageComponent, LoveCompatibilityComponent, RouterOutlet, RouterLink, RouterLinkActive, NgbModule],
